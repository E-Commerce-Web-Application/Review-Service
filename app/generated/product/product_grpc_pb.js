...
function serialize_app_generated_products_DeleteResponse(arg) {
  if (!(arg instanceof app_generated_product_product_pb.DeleteResponse)) {
...
function deserialize_app_generated_products_DeleteResponse(buffer_arg) {
  return app_generated_product_product_pb.DeleteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ProductCreateRequest(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ProductCreateRequest)) {
...
function deserialize_app_generated_products_ProductCreateRequest(buffer_arg) {
  return app_generated_product_product_pb.ProductCreateRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ProductIdRequest(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ProductIdRequest)) {
...
function deserialize_app_generated_products_ProductIdRequest(buffer_arg) {
  return app_generated_product_product_pb.ProductIdRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ProductListResponse(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ProductListResponse)) {
...
function deserialize_app_generated_products_ProductListResponse(buffer_arg) {
  return app_generated_product_product_pb.ProductListResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ProductResponse(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ProductResponse)) {
...
function deserialize_app_generated_products_ProductResponse(buffer_arg) {
  return app_generated_product_product_pb.ProductResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ProductUpdateRequest(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ProductUpdateRequest)) {
...
function deserialize_app_generated_products_ProductUpdateRequest(buffer_arg) {
  return app_generated_product_product_pb.ProductUpdateRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ProductUpdateResponse(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ProductUpdateResponse)) {
...
function deserialize_app_generated_products_ProductUpdateResponse(buffer_arg) {
  return app_generated_product_product_pb.ProductUpdateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_generated_products_ShopID(arg) {
  if (!(arg instanceof app_generated_product_product_pb.ShopID)) {
    throw new Error('Expected argument of type app.generated.products.ShopID');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_app_generated_products_ShopID(buffer_arg) {
  return app_generated_product_product_pb.ShopID.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ProductServiceService = exports.ProductServiceService = {
  createProduct: {
    ...
    requestType: app_generated_product_product_pb.ProductCreateRequest,
    responseType: app_generated_product_product_pb.ProductResponse,
  ...
  getProduct: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: app_generated_product_product_pb.ProductIdRequest,
    responseType: app_generated_product_product_pb.ProductResponse,
  ...
  getAllProducts: {
    ...
    responseType: app_generated_product_product_pb.ProductListResponse,
  ...
  updateProduct: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: app_generated_product_product_pb.ProductUpdateRequest,
    responseType: app_generated_product_product_pb.ProductUpdateResponse,
  ...
  deleteProduct: {
    ...
    responseStream: false,
    requestType: app_generated_product_product_pb.ProductIdRequest,
    responseType: app_generated_product_product_pb.DeleteResponse,
    requestSerialize: serialize_app_generated_products_ProductIdRequest,
    requestDeserialize: deserialize_app_generated_products_ProductIdRequest,
  ...
  getProductsFromShopID: {
    path: '/app.generated.products.ProductService/GetProductsFromShopID',
    requestStream: false,
    responseStream: false,
    requestType: app_generated_product_product_pb.ShopID,
    responseType: app_generated_product_product_pb.ProductListResponse,
    requestSerialize: serialize_app_generated_products_ShopID,
    requestDeserialize: deserialize_app_generated_products_ShopID,
    responseSerialize: serialize_app_generated_products_ProductListResponse,
    responseDeserialize: deserialize_app_generated_products_ProductListResponse,
  },
};
